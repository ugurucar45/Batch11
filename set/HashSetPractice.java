...
public class HashSetPractice {
    public static void main(String[] args) {
        ...
        System.out.println(ids1);// show all elements
//        System.out.println(ids1.get());// take a specifically element
        System.out.println(ids1.contains("22"));//false
        System.out.println(ids1.equals("22"));//false
