...
public class TypesOfMaps {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("---------");
            printValues(drinks3);
            System.out.println(drinks3.keySet());   //[2, 5, 7, 9, 11, 22, 33]
            System.out.println(drinks3.values());   //[Coffee, Pepsi, Coke, Water, Tea, null, null]
    ...
    public static void printValues(Map<Integer,String> storage){
        ...
        for (Integer s:storage.keySet()){
            System.out.println(storage.get(s));
        }
    }
}
